Movie Quiz – Ticket + Loading patch v8
...
V8 UX/FLOW FIX
- Nadpis ticketu je mírně posunut výš.
- Kontext Hráč: <jméno> je posunut výš a výrazně zvětšen.
- Pokračovat po vytvoření profilu otevírá avatarový onboarding přímo přes MovieQuizAvatars.openOnboarding().
- Po potvrzení avatara se vyvolá showView('difficulty'), takže naváže standardní obrazovka výběru možností.
- Obnovení existujícího profilu přes recovery code avatara znovu nevynucuje a pokračuje standardně.
